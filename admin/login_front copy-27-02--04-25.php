        ...
        <div class="nav-container">
            ...
            <div class="nav-menu" id="navMenu">
                <?php if (isset($_SESSION['admin']) && $_SESSION['admin_username'] === 'admin') { ?>
                    ...
                    <a href="manage_rooms.php" class="nav-link">Rooms</a>
            ...
            <div class="actions-grid">
                ...
                <a href="manage_bookings.php" class="action-card">
                    ...
                    <div class="action-text">
                        ...
                        <a href="manage_bookings.php"></a><br>
                ...
                <a href="logout.php" class="action-card btn-logout">
                <?php } else { ?>
                <a href="logout.php" class="action-card btn-login">
                <?php } ?>
                    <div class="action-icon">
                        <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
